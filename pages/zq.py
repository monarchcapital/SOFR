...
zq_spreads_df = pd.DataFrame([
    {
        ...
        "ZQ Price Spread": round(
            zq_df.iloc[i]["ZQ Price"] - zq_df.iloc[i+1]["ZQ Price"], 5
        )
    }
...
# ======================================================
# 8. BUILD EXACT POLICY STEP FUNCTION
# ======================================================
policy_steps = []
...
# ======================================================
# 9. EXACT DAILY COMPOUNDING FUNCTION
# ======================================================
...
sr3_df = pd.DataFrame([
    {
        ...
        "Start": q["Start"].date(),
        "End": q["End"].date(),
        "Implied SR3 Rate (%)": round(
            compounded_sr3_rate(q["Start"], q["End"], policy_steps), 6
        ),
        "Implied SR3 Price": round(
            100 - compounded_sr3_rate(q["Start"], q["End"], policy_steps), 6
        ),
    }
...
sr3_spreads_df = pd.DataFrame([
    {
        ...
        "SR3 Price Spread": round(
            ...
            - sr3_df.iloc[i+1]["Implied SR3 Price"], 6
        )
    }
